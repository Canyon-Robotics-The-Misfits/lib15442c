...
namespace lib15442c
{
    ...
    public:
         ...
         * @param extended_state Whether the pneumatic is extended when the solenoid is set to true
         */
        Pneumatic(char adi_port, bool default_state = false, bool extended_state = true);
         ...
         * @param extended_state Whether the pneumatic is extended when the solenoid is set to true
         */
        Pneumatic(int extender_port, char adi_port, bool default_state = false, bool extended_state = true);
